...
from secrets_app.auth.dependencies import redirect_authenticated, get_auth_client
...
@router.get("/logout")
async def logout(client: Annotated[AuthClient, Depends(get_auth_client)]) -> Response:
    await client.logout()
